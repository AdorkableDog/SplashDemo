...
import xiaobumall.printfuture.com.gaodemapwebview.App;
...
public enum ConfigManage {
    ...
    private final String key_splash_url = "keySplashUrl";
    ...
    private String bannerURL,splashURL;
    ...
    public void initConfig(Context context) {
        ...
        //启动页面的 URL ----------------
        splashURL = sharedPreferences.getString(key_splash_url, "");
        // 启动页是否显示妹子图
    ...
    public void setSplashURL(String splashURL) {
        SharedPreferences sharedPreferences = App.getInstance().getSharedPreferences(spName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(key_splash_url, splashURL);
        if (editor.commit()) {
